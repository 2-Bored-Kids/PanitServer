...
public class PenSettingsPacket extends Packet {
  public PenSettingsPacket() { super(PacketIds.SETTING); }
  ...
  public PenSettingsPacket(String id,
                           Buntstift pen,
                           byte fillMode,
                           Color color,
                           byte paintMode) {
  ...
  public PenSettingsPacket(String str) { this(decode(str)); }
  ...
  public PenSettingsPacket(String[] str) {
    ...
    PEN.setzeFarbe(new Color(Integer.parseInt(str[3]),
  ...
  public String encode() {
    return Integer.toString(PacketIds.SETTING) +
      merge(new Object[] { ID,
                           PEN_COLOR.getRed(),
                           PEN_COLOR.getGreen(),
                           PEN_COLOR.getBlue(),
